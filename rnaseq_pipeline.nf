...
include { BBMAP_BBSPLIT               } from './modules'
include { SAMTOOLS_SORT               } from './modules'
include { PRESEQ_LCEXTRAP             } from './modules'
include { QUALIMAP_RNASEQ             } from './modules'
include { SORTMERNA                   } from './modules'
include { STRINGTIE_STRINGTIE         } from './modules'
include { SUBREAD_FEATURECOUNTS       } from './modules'
include { CUSTOM_DUMPSOFTWAREVERSIONS } from './modules'
...
include { BAM_SORT_STATS_SAMTOOLS          } from './subworkflows'
include { BAM_MARKDUPLICATES_PICARD        } from './subworkflows'
include { BAM_RSEQC                        } from './subworkflows'
include { BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS as BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS_GENOME        } from './subworkflows'
include { BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS as BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS_TRANSCRIPTOME } from './subworkflows'
